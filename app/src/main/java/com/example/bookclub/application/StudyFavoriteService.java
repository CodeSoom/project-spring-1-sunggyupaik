...
public class StudyFavoriteService {
	 ...
	 */
	public StudyDto.StudyFavoriteResultDto favoriteStudy(UserAccount userAccount, Long studyId) {
		...
		return StudyDto.StudyFavoriteResultDto.of(createdFavorite.getId());
	}
	 ...
	 */
	public StudyDto.StudyFavoriteResultDto unFavoriteStudy(UserAccount userAccount, Long studyId) {
		Long accountId = userAccount.getAccount().getId();
		...
		return StudyDto.StudyFavoriteResultDto.of(savedFavorite.getId());
	}
}
